...
public class FileUtil {
	...
	public List<FileVO> setFiles(MultipartFile[] file,int bno) throws IllegalStateException, IOException {
		...
		for(MultipartFile f : file) {
		    ...
		    String fileUrl = "C:/Users/park517/git/Zara/zara/src/main/webapp/resources/upload/";
	        do { 
